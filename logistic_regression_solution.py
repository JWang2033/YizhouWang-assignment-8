...
def do_experiments(start, end, step_num):
    ...
    for i, distance in enumerate(shift_distances, 1):
        ...
        if beta2 != 0:
            slope = -beta1 / beta2  # slope of the line separating the classes
            intercept = -beta0 / beta2  # y-intercept of the decision boundary
        else:
            slope = None
            intercept = None

        # Store the calculated values for further analysis
    ...
    plt.subplot(3, 3, 2)
    plt.plot(shift_distances, beta1_list, marker='o', color='orange', label='Beta1')
    ...
    plt.subplot(3, 3, 3)
    plt.plot(shift_distances, beta2_list, marker='o', color='green', label='Beta2')
    ...
    # Plot logistic loss
    plt.subplot(3, 3, 6)
    plt.plot(shift_distances, loss_list, marker='o', color='brown', label='Logistic Loss')
    ...
    plt.subplot(3, 3, 7)
    plt.plot(shift_distances, margin_widths, marker='o', color='cyan', label='Margin Width')
